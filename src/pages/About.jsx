...
/>
      ...
      <div className="bg-[#0A0F1C] text-white">
        ...
        {/* HERO */}
        <section className="min-h-[68vh] flex items-center justify-center text-center px-6">
        ...
        <section className="py-24 px-6 border-t border-gray-800">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              ...
              person, the capability, the infrastructure, and the asset.
              It is designed to help people see where they are weak, build in
              the right order, and create something strong enough to outlive a
